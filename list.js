// === Liste des 227 Pokémon (dans l'ordre du jeu) ===
const pokemonNames = [
...
// Stockage des pokémon chargés
let pokemons = [];

// Fonction pour récupérer le sprite shiny depuis PokéAPI
...
async function loadAll() {
  for (let i = 0; i < pokemonNames.length; i++) {
    ...
    const p = await fetchPokemonData(name, i + 1);
    pokemons.push(p);
